...
import ResearchFigure from "../_components/ResearchFigure";
import UxTakeaway from "../_components/UxTakeaway";
import { createResearchAssets } from "../_lib/researchAssets";

const SLUG = "habit-together-healthcare-ux";
const { coverSrc, figureSrc } = createResearchAssets(SLUG, { format: "webp" });
    ...
    return (
        <main className="main main-research">
            <ResearchHero
                ...
                headline="건강 습관은 왜 혼자 만들기 어려울까?"
                subhead="지속 가능한 습관 형성을 위한 지능형 헬스케어 서비스 제안"
                cover={{ src: coverSrc(), width: 1672, height: 941 }}
                meta={[
                    {
                        term: "Paper Title",
                        description: (
                            <>
                                사용자경험 단계를 고려한 지능형 헬스케어 서비스 제안: 지속 가능한
                                습관 형성을 중심으로
                                <br />
                                (Developing the Intelligent Healthcare Service Considering the Stage
                                of User Experience: based on the Sustainable Habit Formation)
                            </>
                        ),
                    },
                    {
                        term: "Type",
                        description: "UX Research / Service Design / Published Research",
                    },
                    {
                        term: "Authors",
                        description: (
            ...
            >
                ...
                <p className="section-typography-body">
                    ...
                    직접 기록해야 하고, 목표를 세워도 일상 속 변수 때문에 쉽게 무너질 수 있습니다.
                </p>
                <p className="section-typography-body">
                    이 연구는 건강 습관 형성이 실패하는 이유를 사용자 조사로 확인했습니다. 그리고
                    자동 기록, 유동적인 목표 추천, 지인과의 공유, 선택적 공개 기능을 바탕으로{" "}
                    <em>해빗 투게더(Habit Together)</em>라는 헬스케어 서비스를 제안했습니다.
                </p>
                <p className="section-typography-body">
                    결국 이 연구의 핵심은 단순합니다.{" "}
                    <em>
            ...
            <ResearchSection
                ...
                headline="건강 습관은 의지만으로 지속되기 어렵다."
            >
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    ...
                    체중 같은 항목을 따로 챙겨야 하고, 많은 서비스는 사용자가 직접 기록해야 합니다.
                </p>
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    또 다른 문제는 목표가 너무 고정적이라는 점입니다. 현실의 생활은 매일 달라지는데,
                    목표는 그 변화를 충분히 반영하지 못합니다.
                </p>
                <p className="section-typography-body">
                    그래서 이 연구는 건강 습관 형성을 <em>개인의 의지 문제</em>로만 보지 않았습니다.
                    사용자가 계속 실천할 수 있도록 돕는 <em>지원 구조의 문제</em>로 봤습니다.
                </p>
            </ResearchSection>
            <ResearchSection
                name="research-background"
                eyebrow="Research Background"
                headline="팬데믹 이후 자기 관리의 중요성이 커졌다."
            >
                <p className="section-typography-body">
                    2020년 이후 팬데믹은 사람들의 생활 방식을 크게 바꿨습니다. 비대면 활동이 늘고,
                    혼자 생활하는 시간이 많아졌습니다.
                </p>
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    1인 가구는 혼자 생활하는 만큼 자기 관리의 필요성이 큽니다. 하지만 동시에 건강
                    습관을 유지하도록 도와주는 외부 자극은 부족할 수 있습니다.
                </p>
                <p className="section-typography-body">
            ...
            <ResearchSection
                ...
                headline="설문, 인터뷰, 다이어리 스터디, 사용성 테스트로 문제를 찾았다."
            >
                <p className="section-typography-body">
            ...
            <ResearchSection
                ...
                headline="기존 건강 습관 앱은 기록과 정보 부담을 만들었다."
            >
                <p className="section-typography-body">
            ...
            <ResearchSection
                ...
                headline="사람들은 건강 습관에 관심은 많지만, 지속에는 실패한다."
            >
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    하지만 관심이 높다고 해서 습관이 쉽게 유지되는 것은 아니었습니다. 건강 습관을
                    유지하는 이유도 개인의 꾸준한 노력이고, 실패하는 이유도 개인의 노력에만
                    의존하기 때문이었습니다.
                </p>
                <p className="section-typography-body">
                    이 결과는 중요한 시사점을 줍니다. 건강 습관은 의지만으로 지속되기 어렵습니다.
                    주변 사람의 도움, 기기 기반 지원, 자동화 같은 외부 지원이 필요합니다.
                </p>
                <div className="figures-row">
                    ...
                    <ResearchFigure
                        ...
                        width={1022}
                        height={894}
                        caption="건강 관리 습관 유지의 성공 이유 및 실패 원인"
                    />
                </div>
                <UxTakeaway>
                    <p>
            ...
            <ResearchSection
                ...
                headline="사용자는 기록 피로, 무리한 목표, 공유 부담을 느꼈다."
            >
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    심층 인터뷰에서는 직접 기록의 귀찮음, 무리한 체중 감량 경험, 함께할 사람을 찾기
                    어려운 문제, 지인과 함께할 때 생기는 동기부여가 드러났습니다.
                </p>
                <p className="section-typography-body">
                    다이어리 스터디에서는 사용자가 일상 속 변수에 맞춰 습관을 유동적으로
                    조절한다는 점이 보였습니다. 예를 들어 운동할 시간이 없으면 계단을 이용하거나,
                    식단에 변수가 생기면 먹는 양을 줄이고 물을 더 마시는 방식이었습니다.
                </p>
                <p className="section-typography-body">
                ...
                <ResearchFigure
                    ...
                    width={1028}
                    height={646}
                    caption="정성적 조사 대상자 정보"
                />
                <UxTakeaway>
                    <p>
                        사용자는 건강 습관을 만들고 싶어 합니다. 하지만 매번 직접 기록하는 구조는
                        쉽게 피로를 만듭니다.
                    </p>
                    <p>
                        목표가 현실과 맞지 않으면 동기부여도 떨어집니다. 또 공유는 도움이 되지만,
                        아무에게나 공개되는 것은 부담이 됩니다.
                    </p>
                    <p>
            ...
            <ResearchSection
                ...
                headline="사용자 조사는 네 가지 핵심 문제로 정리되었다."
            >
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    이 네 가지는 서비스 방향을 결정하는 기준이 됐습니다. 즉, 서비스는 기록을 줄이고,
                    목표를 현실에 맞게 조정하고, 지인의 긍정적 자극을 활용하되, 공유 범위는
                    사용자가 조절할 수 있어야 했습니다.
                </p>
                <UxTakeaway>
                    <p>
                        이 단계는 단순한 문제 정리가 아닙니다. 사용자 조사 결과를 서비스 전략으로
                        바꾸는 연결 지점입니다.
                    </p>
                    <p>
            ...
            <ResearchSection
                ...
                headline="해빗 투게더는 자동 기록, 목표 추천, 지인 공유, 선택적 공개를 제안한다."
            >
                <p className="section-typography-body">
                ...
                <div className="figures-grid">
                    <ResearchFigure
                        ...
                        width={1028}
                        height={980}
                        caption="자동 기록 기능 상세 설명 및 가능 서비스"
                    />
                    <ResearchFigure
                    ...
                    <ResearchFigure
                        ...
                        width={1028}
                        height={408}
                        caption="공유 데이터 접근 권한 기능 상세 설명"
                    />
                </div>
                <UxTakeaway>
                    <p>
                        해빗 투게더의 핵심은 사용자를 더 많이 관리하는 것이 아닙니다. 사용자가 건강
                        습관을 계속 이어갈 수 있도록 부담을 줄이는 것입니다.
                    </p>
                    <p>
                        자동 기록은 기록 피로를 줄입니다. 목표 추천은 무리한 목표를 줄입니다. 지인
                        공유는 동기부여를 만듭니다. 선택적 공개는 공유 부담을 줄입니다.
                    </p>
                </UxTakeaway>
            </ResearchSection>
            <ResearchSection
                name="service-scenario"
                eyebrow="Service Scenario"
                headline="습관은 혼자 관리하는 것이 아니라 함께 이어가는 경험이 된다."
            >
                <p className="section-typography-body">
            ...
            <ResearchSection
                name="prototype"
                eyebrow="Prototype"
                headline="웨어러블과 앱은 서로 다른 역할을 맡는다."
            >
                <p className="section-typography-body">
                ...
                <UxTakeaway>
                    ...
                    <p>
                        앱은 데이터 확인, 목표 설정, 지인 활동 확인, 주간 리포트처럼 더 깊은 관리에
                        적합합니다. 즉, 기기별 역할을 나누는 것이 중요합니다.
                    </p>
                </UxTakeaway>
            </ResearchSection>
            <ResearchSection
                ...
                headline="건강 습관 서비스는 의지를 요구하기보다 지속을 도와야 한다."
            >
                <p className="section-typography-body">
            ...
            <ResearchSection
                name="limitations"
                eyebrow="Limitations"
                headline="실제 서비스 검증과 기술 구현 가능성은 더 확인해야 한다."
            >
                <p className="section-typography-body">
                    이 연구는 서비스 제안과 프로토타입 중심으로 진행됐습니다. 따라서 실제 출시 후
                    장기 사용 데이터를 검증한 것은 아닙니다.
                </p>
                <p className="section-typography-body">
                    또한 웨어러블 기반 자동 기록은 당시 기술 수준에서 한계가 있었습니다.
                    스마트워치가 모든 건강 행동을 정확하게 감지할 수 있는 것은 아니기 때문입니다.
                </p>
                <p className="section-typography-body">
            ...
            <ResearchSection
                ...
                headline="지속 가능한 습관은 의지가 아니라 지원 구조에서 만들어진다."
            >
                <p className="section-typography-body-emp">
                    이 연구는 건강 습관 형성의 문제를 개인의 의지 부족이 아니라 UX 지원 구조의
                    문제로 보고, 자동 기록·유동적 목표·지인 공유·선택적 공개를 중심으로 한 헬스케어
                    서비스를 제안했습니다.
                </p>
            </ResearchSection>
