...
const SLUG = "autonomous-vehicle-trust-ux";
const { coverSrc, figureSrc, figureSrcSet } = createResearchAssets(SLUG, {
    format: "jpg-srcset",
});
    ...
    return (
        <main className="main main-research">
            <ResearchHero
                ...
                subhead="신뢰를 만들기 위한 UX 정보 가이드라인 연구"
                ...
                meta={[
                    ...
                    { term: "Type", description: "Published UX Research" },
                    {
                        term: "Methods",
                        description:
                    ...
                    {
                        term: "Outcome",
                        description: "UX Information Guidelines for Level 5 Autonomous Vehicles",
                    },
                    {
                        term: "Publication",
                        description: "Journal of Digital Contents Society, 2025",
                    },
                ]}
                download={{
            ...
            <ResearchSection
                name="overview"
                eyebrow="Overview"
                headline="완전자율주행차의 정보는 주행 상황과 신뢰 수준에 따라 달라져야 한다."
            >
                <p className="section-typography-body">
                    완전자율주행차에서는 사람이 직접 운전하지 않습니다. 차가 주변 상황을 인식하고,
                    스스로 경로와 속도를 조절합니다.
                </p>
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    이 연구는 완전자율주행차가 어떤 정보를 보여줘야 사용자가 차를 신뢰할 수 있는지
                    살펴봤습니다. 인터뷰로 사용자가 원하는 정보를 찾고, 설문으로 주행 상황과 신뢰
                    수준에 따라 어떤 정보가 더 중요한지 확인했습니다.
                </p>
                <p className="section-typography-body">
                    그 결과, 처음 사용하는 사람에게는 안전 정보와 차량 상태 정보가 중요했습니다.
                    차를 더 신뢰하게 될수록 일정, 목적지, 다음 이동처럼 사용자 상황에 맞춘 정보가
                    더 중요해졌습니다.
                </p>
                <p className="section-typography-body">
                    결국 완전자율주행차의 UX는 모든 정보를 많이 보여주는 방식이 아닙니다.{" "}
                    <em>
                        주행 상황과 신뢰 수준에 따라 필요한 정보를 골라 보여주는 방식이어야 합니다.
                    </em>
                </p>
            </ResearchSection>
            <ResearchSection
                ...
                headline="직접 운전하지 않으면, 차가 잘하고 있는지 알 수 없어 불안해진다."
            >
                <p className="section-typography-body">
                    완전자율주행차가 실제로 쓰이려면 기술만 좋아서는 부족합니다. 사용자가 차를 믿고
                    맡길 수 있어야 합니다.
                </p>
                <p className="section-typography-body">
                    문제는 사용자가 직접 운전하지 않는다는 점입니다. 차가 알아서 움직이면 편할 수
                    있지만, 동시에 불안할 수도 있습니다.
                </p>
                <p className="section-typography-body">
                    운전자가 직접 조작하지 않으면 차가 지금 잘하고 있는지 바로 알기 어렵습니다.
                    차가 왜 속도를 줄이는지, 왜 경로를 바꾸는지 모르면 불안은 더 커질 수 있습니다.
                </p>
                <p className="section-typography-body">
            ...
            <ResearchSection
                ...
                headline="신뢰는 기술 수용, 시스템 투명성, 주행 맥락을 함께 봐야 설명할 수 있다."
            >
                <p className="section-typography-body">
                ...
                <ResearchFigure
                    ...
                    srcSet={figureSrcSet("figure3")}
                    alt="완전자율주행 신뢰특성의 연구 모델"
                    width={1574}
                    height={1061}
                    caption="완전자율주행 신뢰특성의 연구 모델"
                />
                <UxTakeaway>
                    <p>
                        사용자의 신뢰는 한 번에 생기지 않습니다. 처음에는 차가 잘하고 있는지 계속
                        확인하고 싶어 합니다. 익숙해질수록 확인해야 할 정보는 줄어듭니다.
                    </p>
                    <p>
                        이 연구는 이 흐름을 <em>초기 적응 → 일상 사용 → 완전 수용</em>의 세 단계로
                        나눠 살펴봤습니다. 따라서 완전자율주행차의 UX는 신뢰 단계에 따라 정보의
                        양과 깊이를 다르게 설계해야 합니다.
                    </p>
                </UxTakeaway>
            </ResearchSection>
            <ResearchSection
                ...
                headline="인터뷰로 필요한 정보를 찾고, 설문으로 중요도를 확인했다."
            >
                <p className="section-typography-body">
                ...
                <p className="section-typography-body">
                    먼저 참여자들에게 완전자율주행차를 탄 상황을 상상하게 했습니다. 그리고 출발 전,
                    주행 중, 도착 전후, 위험 상황에서 어떤 정보가 필요한지 물었습니다.
                </p>
                <p className="section-typography-body">
            ...
            <ResearchSection
                ...
                headline="사람들은 모든 정보보다 상황에 맞는 정보를 원했다."
            >
                <p className="section-typography-body">
                    인터뷰 결과, 사람들은 모든 정보를 다 알고 싶어 하지 않았습니다. 지금 상황에 꼭
                    필요한 정보를 원했습니다.
                </p>
                <ul className="list">
                    <li>
                ...
                <ResearchFigure
                    ...
                    srcSet={figureSrcSet("table3")}
                    alt="포커스 그룹 인터뷰 분석 결과"
                    width={921}
                    height={1034}
                    caption="포커스 그룹 인터뷰 분석 결과"
                />
                <UxTakeaway>
                    <p>
                        사용자는 모든 정보를 원하지 않았습니다. 출발 전, 주행 중, 도착 전후, 위험
                        상황마다 필요한 정보가 달랐습니다.
                    </p>
                    <p>
                        따라서 완전자율주행차의 화면과 알림은 한 가지 방식으로 고정되면 안 됩니다.
                        상황에 따라 먼저 보여줄 정보가 달라져야 합니다.
                    </p>
                </UxTakeaway>
            </ResearchSection>
            <ResearchSection
                name="information-categorization"
                eyebrow="Information Categorization"
                headline="사용자 의견은 UX 설계에 쓸 수 있는 정보 구조로 바뀌었다."
            >
                <p className="section-typography-body">
                ...
                <ResearchFigure
                    ...
                    srcSet={figureSrcSet("table4")}
                    alt="포커스 그룹 인터뷰에서 도출된 정보들의 유형화"
                    width={632}
                    height={1292}
                    caption="포커스 그룹 인터뷰에서 도출된 정보들의 유형화"
                />
                <UxTakeaway>
                    <p>
            ...
            <ResearchSection name="quantitative-analysis" wrap={false}>
                <div className="section-content">
                    <h2
                        id="quantitative-analysis-heading"
                ...
                <div className="section-content">
                    ...
                    <ul className="list">
                        ...
                        <li>
                            <strong>분석 목적</strong>
                            <span>
                                주행 상황과 신뢰 수준에 따라 중요한 정보가 달라지는지 확인
                            </span>
                        </li>
                    </ul>
                </div>
                <div className="section-content">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    주행 중에는 정보 유형과 신뢰 단계 모두 중요도에 영향을
                                    줬습니다.
                                </td>
                            </tr>
                            <tr>
                    ...
                    <ResearchFigure
                        ...
                        srcSet={figureSrcSet("figure4")}
                        alt="출발 전 정보 중요도 분석 결과"
                        width={1826}
                        height={688}
                        caption="출발 전 정보 중요도 분석 결과"
                    />
                    <ResearchFigure
                        src={figureSrc("figure5")}
                        srcSet={figureSrcSet("figure5")}
                        alt="주행 중 정보 중요도 분석 결과"
                        width={1826}
                        height={687}
                        caption="주행 중 정보 중요도 분석 결과"
                    />
                    <ResearchFigure
                        src={figureSrc("figure6")}
                        srcSet={figureSrcSet("figure6")}
                        alt="도착 전 정보 중요도 분석 결과"
                        width={1826}
                        height={683}
                        caption="도착 전 정보 중요도 분석 결과"
                    />
                    <ResearchFigure
                        src={figureSrc("figure7")}
                        srcSet={figureSrcSet("figure7")}
                        alt="도착 후 정보 중요도 분석 결과"
                        width={1826}
                        height={428}
                        caption="도착 후 정보 중요도 분석 결과"
                    />
                </div>
                <div className="section-content">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    도착 전에는 주차, 충전, 점검처럼 바로 행동으로 이어지는
                                    정보를 먼저 보여줍니다.
                                </td>
                            </tr>
                            <tr>
            ...
            <ResearchSection
                ...
                headline="신뢰 수준이 달라지면 필요한 정보도 달라진다."
            >
                <p className="section-typography-body">
                    완전자율주행차는 처음부터 끝까지 같은 정보를 보여주면 안 됩니다. 사용자의 신뢰
                    수준에 따라 필요한 정보가 달라지기 때문입니다.
                </p>
                <ul className="list type2">
                    <li>
                        <strong>초기 단계 — 안전 확인, 차량 상태, 비상 대응 정보</strong>
                        <span>
                            사용자가 직접 통제하지 못하는 상황에서 차를 의심하지 않게 만들기 위해
                            필요합니다.
                        </span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span>
                            차의 작동 자체는 더 이상 크게 의심하지 않습니다. 정보는 사용자의 다음
                            행동과 생활 흐름에 맞춰져야 합니다.
                        </span>
                    </li>
                </ul>
            ...
            >
                ...
                <p className="section-typography-body">
                    또한 위험 상황은 인터뷰에서는 다뤘지만 설문 단계에서는 다루지 않았습니다. 위험
                    상황의 정보 설계는 별도의 안전 검증이 필요하기 때문입니다.
                </p>
                <p className="section-typography-body">
                    이 외에도 나이, 운전 경험, 기술 친숙도에 따라 필요한 정보가 달라질 수 있습니다.
                    이 차이도 추가로 살펴봐야 합니다.
                </p>
            </ResearchSection>
            <ResearchSection
                ...
                headline="주행 상황과 신뢰 수준이 정보의 우선순위를 바꾼다."
            >
                <p className="section-typography-body-emp">
