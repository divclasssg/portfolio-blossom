            ...
            <label className={styles['consent-item']}>
              ...
              <div className={styles['consent-text']}>
                ...
                <span id="mydata-detail" className={styles['consent-detail']}>
                  국민건강보험공단 및 의료기관의 진료 이력, 처방 이력,
                  건강검진 결과를 이음 서비스에 제공하는 데 동의합니다.
                </span>
              </div>
            </label>
          </div>
            ...
            <label className={styles['consent-item']}>
              ...
              <div className={styles['consent-text']}>
                ...
                <span id="overseas-detail" className={styles['consent-detail']}>
                  AI 분석을 위해 건강 데이터 일부가 해외 AI 서비스(OpenAI, Google)에
                  전송됩니다. 전송 전 개인 식별 정보는 제거됩니다.
                </span>
                <span className={styles['overseas-info']}>
                  수신국: 미국 | 수신자: OpenAI Inc., Google LLC | 이전 항목: 증상 기록, 진료 요약
                </span>
              </div>
            </label>
          </div>
