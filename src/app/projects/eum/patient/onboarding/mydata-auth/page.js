...
export default function MydataAuthPage() {
    ...
    const isValid =
        residentFront.replace(/\D/g, '').length === 6 &&
        residentBack1.length === 1 &&
        !residentError;
            ...
            <main className={styles['page']}>
                <section className={styles['content']} aria-labelledby="mydata-auth-title">
                    ...
                    <div className={styles['field-group']}>
                        ...
                        <div
                            className={styles['resident-row']}
                            role="group"
                            aria-labelledby="resident-label"
                        >
                            <input
                                id="resident-input"
                                type="text"
                            ...
                            />
                            <span className={styles['resident-sep']} aria-hidden="true">
                                -
                            </span>
                            <div className={styles['resident-back']}>
                                ...
                                />
                                <span className={styles['resident-mask']} aria-hidden="true">
                                    ●●●●●●
                                </span>
                            </div>
                        </div>
                        ...
                        >
                            {[
                                ...
                                <label key={method.value} className={styles['auth-option']}>
                                    ...
                                    />
                                    <span className={styles['auth-option-label']}>
                                        {method.label}
                                    </span>
                                </label>
                            ))}
