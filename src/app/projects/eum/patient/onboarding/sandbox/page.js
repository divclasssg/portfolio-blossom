                    ...
                    <div className={styles['notice-card']}>
                        ...
                        <div className={styles['notice-body']}>
                            ...
                            <p className={styles['notice-item']}>
                                ㅇ 주요내용: 마이데이터 기반 맞춤형 만성질환 및 중증이환 예방·관리
                                서비스
                            </p>
                            <p className={styles['notice-item']}>
                                ㅇ 유효기간: 사업 개시일로부터 2026.3.13.까지
                            </p>

                            <p className={styles['notice-section']}>2. 규제특례 구역, 기간, 규모</p>
                            <p className={styles['notice-item']}>ㅇ 구역: 전국</p>
                            <p className={styles['notice-item']}>
                                ㅇ 기간: 1년 내외 (사업 개시일로부터 2026.3.13.까지)
                            </p>
                            <p className={styles['notice-item']}>
                                ㅇ 규모: 서비스 이용자 500명 내외
                            </p>

                            <p className={styles['notice-section']}>
                                3. 법 제10조의3 제7항의 안정성 등 확보 조건
                            </p>
                            <p className={styles['notice-item']}>
                                ㅇ「개인정보보호법 시행령」시행 이전에는 전송요구서가 아닌「의료법
                                시행규칙」서식의 동의서 및 위임장 제출 필요
                            </p>
                            <p className={styles['notice-subitem']}>
                                - 동의서 및 위임장 서식을 법인에 맞게 변경 필요 (신청인 및 위임인
                                성명, 생년월일을 법인명, 사업자번호로 변경 필요)
                            </p>
                            <p className={styles['notice-subitem']}>
                                - 해당 정보 제공 시마다 환자에게 별도 통보 필요
                            </p>
                            <p className={styles['notice-item']}>
                                ㅇ「개인정보보호법 시행령」개정을 통해 전송요구권 관련 세부 절차
                                마련 시, 제도 시행일로부터 1년 이내에 법 제35조의3 제2항에 따른 지정
                                요건을 갖추어 개인정보관리 전문기관으로 지정받아야 하며, 해당 기간
                                이내에 개인정보관리 전문기관으로 지정을 받지 아니한 자는
                                개인정보관리 관련 업무를 중단하여야 함
                            </p>

                            <p className={styles['notice-section']}>4. 개인정보 처리 관련 안내</p>
                            <p className={styles['notice-item']}>
                                ㅇ 본 서비스는 「개인정보 보호법」제39조의3에 따른 실증특례로
                                운영되며, 수집된 건강 데이터는 서비스 목적 외 활용되지 않습니다.
                            </p>
                            <p className={styles['notice-item']}>
                                ㅇ 이용자는 언제든지 데이터 제공 동의를 철회할 수 있으며, 철회 시
                                수집된 데이터는 즉시 파기됩니다.
                            </p>
                        </div>
