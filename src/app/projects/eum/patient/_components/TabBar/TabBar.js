...
const TABS = [
  ...
  },
  {
    ...
    icon: (
      // 기록 아이콘 (클립보드)
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <rect x="5" y="3" width="14" height="18" rx="2" strokeWidth="1.8" strokeLinecap="round"/>
        <path d="M9 3v2h6V3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    iconActive: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <path d="M9 3v2h6V3" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  },
  {
    ...
    iconActive: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <path d="M14 2v6h6M9 13h6M9 17h4" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    ...
    iconActive: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" strokeWidth="2" strokeLinecap="round" stroke="currentColor" fill="none"/>
      </svg>
    ),
  },
];
