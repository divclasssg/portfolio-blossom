...
export default function BpChart({ data, symptomDays, xTicks }) {
  return (
    ...
    >
      ...
      <ReferenceArea y1={90} y2={120} fill={REFERENCE_RANGE_COLOR} fillOpacity={0.3} strokeOpacity={0} />
      {/* 이완기 정상 범위 (60–80 mmHg) */}
      <ReferenceArea y1={60} y2={80} fill={REFERENCE_RANGE_COLOR} fillOpacity={0.3} strokeOpacity={0} />
      ...
      <Area dataKey="base" stackId="bp" stroke="none" fill="none" activeDot={false} legendType="none" />
      <Area
        dataKey="band"
        stackId="bp"
        stroke="none"
