...
// 오늘 기준 동적 계산
export const END_DATE = getKstToday();
...
export const PERIOD_FROM = {
    '1day': END_DATE,
    '1week': subtractDays(END_DATE, 6),
    '1month': subtractDays(END_DATE, 30),
    '6months': subtractDays(END_DATE, 182),
    '1year': subtractDays(END_DATE, 365),
};
