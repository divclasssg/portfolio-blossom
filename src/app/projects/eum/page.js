        ...
        <main id="main" className="main">
            ...
            <section className="section section-dd-define">
                <div className="section-content">
                    ...
                    <p className="typography-copy">
                        ...
                        충분히 쓰이지 못했습니다. 문제를 &apos;환자 기록 → 진료 맥락, 진료 결과 →
                        환자 이해와 다음 행동&apos;이 끊기는 구조로 정의했습니다.
                    </p>
                    ...
                    <p className="typograpy-callout-headline">
                        왜 그런 결과이고, 다음에 무엇을 해야 하는지.
                    </p>
                    <p className="typograpy-callout-copy">
                        정상이라는 말은 환자에게 정보가 아니라 “갈 길이 없다”는 상태로 느껴졌고,
                        환자가 원한 것은 결과 한 줄이 아니라 이유와 다음 단계가 연결된 구조였습니다.
                    </p>
                    ...
                    <p className="typography-callout-copy">
                        ...
                        정보와 한눈에 읽히는 요약 포맷이었습니다. 소스에서도 최소 의사결정 정보와
                        선호 포맷을 따로 구조화했고, “눈에 팍 보이게” 읽히는 정보가 필요하다는
                        표현이 반복되었습니다.
                    </p>
                    <h3 className="visuallyhidden">UX Research Methodology</h3>
                    <div className="define-methodology">
                        <div className="define-methodology-content">
                            <h4 className="section-label">환자 통합 분석</h4>
                            <p className="section-headline-samll">
                                환자가 원하는 것은 결과 자체보다 이유와 관리 계획이었습니다.
                            </p>
                            <p className="typography-copy">
                                텍스트 분석과 인터뷰를 따로 보면, 환자가 실제로 무엇을 원하고
                                무엇에서 막히는지 설계 기준으로 쓰기 어려웠습니다. 온라인 텍스트와
                                환자 인터뷰를 통합해 페인 포인트와 니즈를 하나의 구조로
                                정리했습니다.
                            </p>
                            <p className="typography-copy">
                                다음으로 이 요구가 의료진의 실제 진료 흐름 안에서도 성립하는지
                                확인했습니다.
                            </p>
                            <div className="tag-wrapper">
                                <h5 className="visuallyhidden">UX Research Methodology keywords</h5>
                                <ul className="tags">
                                    <li className="tags-item">#PARETO_분석</li>
                                    <li className="tags-item">#신뢰도x중요도_분석</li>
                                    <li className="tags-item">#환자_1:1심층인터뷰_분석</li>
                                    <li className="tags-item">#교차검증</li>
                                    <li className="tags-item">#테마도출</li>
                                </ul>
                            </div>
                            <Link
                                href="#"
                    ...
                    <div className="define-methodology">
                        <div className="define-methodology-content">
                            <h4 className="section-label">의료진 심층 인터뷰 분석</h4>
                            <p className="section-headline-small">
                                의료진에게 필요한 것은 더 많은 데이터보다, 짧은 시간 안에 바로
                                판단에 쓸 수 있는 정보였습니다.
                            </p>
                            <p className="typography-copy">
                                의료진이 실제로 먼저 보는 정보와 병목을 하나의 구조로 묶었습니다.
                                인터뷰를 개별 사례로만 보면, 의료진이 무엇을 먼저 확인하고 어디서
                                판단이 막히는지 설계 기준으로 쓰기 어려웠습니다. 의료진 인터뷰를
                                요약 코드와 클러스터로 통합해 최소 판단 정보, 정보 공백, 워크플로우
                                병목, 문서화 부담을 하나의 구조로 정리했습니다.
                            </p>
                            <p className="typography-copy">
                                다음으로 이 구조를 환자 니즈와 같은 비교축 위에 놓고, 실제 진료
                                안에서 무엇이 연결을 끊는지 다시 정의했습니다.
                            </p>
                            <div className="tag-wrapper">
                                <h5 className="visuallyhidden">UX Research Methodology keywords</h5>
                                <ul className="tags">
                                    <li className="tags-item">#Affinity_Diagram</li>
                                </ul>
                            </div>
                            <Link
                                href="#"
                    ...
                    <div className="define-methodology">
                        <div className="define-methodology-content">
                            <h4 className="section-label">환자 &middot; 의료진 통합 분석</h4>
                            <p className="section-headline-small">
                                핵심은 정보 부족이 아니라, 짧은 진료 안에서 의사의 판단이 환자에게
                                왜 그런지와 진료 후 어떻게 해야 하는지까지 충분히 설명되지 않는다는
                                점이었습니다.
                            </p>
                            <p className="typography-copy">
                                문제를 단순한 정보 부족이 아니라, 환자와 의료진 사이에서 설명과
                                맥락이 끊기는 구조로 다시 정의했습니다. 환자와 의료진 결과를 따로
                                보면 서로 다른 문제처럼 보이지만, 실제 설계는 두 결과 사이에서
                                어디서 이해가 끊기는지를 함께 다뤄야 했습니다. 환자 결과와 의료진
                                결과를 같은 축으로 비교해 통합 해석과 설계 시사점으로 정리했습니다.
                            </p>
                            <p className="typography-copy">
                            ...
                            <div className="tag-wrapper">
                                <h5 className="visuallyhidden">UX Research Methodology keywords</h5>
                                <ul className="tags">
                                    <li className="tags-item">#비교분석</li>
                                    <li className="tags-item">#통합해석</li>
                                    <li className="tags-item">#교차해석</li>
                                    <li className="tags-item">#문제재정의</li>
                                    <li className="tags-item">#설계시사점</li>
                                </ul>
                            </div>
                            <Link
                                href="#"
                    ...
                    <div className="define-methodology">
                        <div className="define-methodology-content">
                            <h4 className="section-label">UX 전략 및 문제 정의</h4>
                            <p className="section-headline-small">
                                환자는 증상에 대한 설명과 이후 방향을 듣고 싶었고, 의사는 판단에
                                필요한 핵심 증상 정보를 먼저 파악하고 싶었습니다.
                            </p>
                            <p className="typography-copy">
                                통합분석에서 확인한 간극을 실제 진료 안의 사람과 상황으로
                                구체화했습니다. 환자는 왜 이런 증상이 의심되는지와 진료 후 어떻게
                                해야 하는지를 알고 싶어 했지만, 의사는 짧은 시간 안에 판단에 필요한
                                증상 정보를 먼저 추려야 했습니다. 그래서 이 단계에서는 두 사람이
                                같은 진료를 어디서 다르게 경험하는지 페르소나와 유저 저니맵으로
                                구체화하고, 그 어긋남을 Problem Statement, User story, How Might
                                We로 다시 정리했습니다.
                            </p>
                            <p className="typography-copy">
                                이렇게 정의한 문제를 바탕으로, 다음 단계에서는 이 간극을 줄이기 위한
                                기능과 흐름을 구체화했습니다.
                            </p>
                            <div className="tag-wrapper">
                                <h5 className="visuallyhidden">UX Research Methodology keywords</h5>
                                <ul className="tags">
                                    <li className="tags-item">#Persona</li>
                                    <li className="tags-item">#User_Journey_Map</li>
                                    <li className="tags-item">#Problem_Statement</li>
                                    <li className="tags-item">#User_Story</li>
                                    <li className="tags-item">#How_Might_We</li>
                                </ul>
                            </div>
                            <Link
                                href="#"
                ...
                <div className="section-content-wide">
                    <div className="card-wrapper">
                        <div className="card-process">
                            <h3 className="card-process-headline">브레인스토밍.</h3>
                            <p className="card-process-typograpy-copy">
                        ...
                        <div className="card-process">
                            <h3 className="card-process-headline">MoSCoW.</h3>
                            <p className="card-process-typography-copy">
                        ...
                        <div className="card-process">
                            <h3 className="card-process-headline">최종 MVP 요약.</h3>
                            <p className="card-process-typography-copy">
            ...
            <section className="section section-standalone section-dd-develop-mvp">
                <div className="standalone-content">
                    <h2 className="section-eyebrow">
                        ...
                        MVP &middot; Minimum Viable Product
                    </h2>
            ...
            <section className="section section-dd-develop-wireframe-to-prototype">
                ...
                <div className="auto-slider">
                    <div className="auto-slider-content">
                        <div className="auto-slider-item card-column">
                            <h4 className="card-column-eyebrow">
                                <span>Key Screen 01.</span>
                                증상 기록 &middot; 환자
                            </h4>
                            <p className="typography-copy-bold">
            ...
            <section className="section section-dd-develop-usability-testing">
                <div className="section-content">
                    ...
                    <div className="ut-results-item">
                        <h4 className="ut-results-headline">
                        ...
                        <figure className="ut-results-screenshot">
                            ...
                            <figcaption>
                                ...
                                환산한 사용성 지표로, 평균값은 전체 수준, 표준편차는 평가 차이,
                                중앙값은 극단값에 덜 흔들리는 대표값을 보여줍니다. 환자 앱은 평균
                                76.5점으로 기본 사용성이 나쁘지 않았고, 의사용 패널은 75점이었지만
                                표본이 1명이라 참고 수준으로 해석했습니다.
                            </figcaption>
                        </figure>
                    </div>
                    <div className="ut-results-item">
                        ...
                        <p className="typography-copy">
                            환자는 기록 기능보다 진료 연결에서 가치를 느꼈고, 메인 화면 &middot;
                            기록 이해 과업은 4.6점으로 가장 낮았습니다. 반복된 질문은 &quot;왜 이런
                            판단인지&quot;와 &quot;어떻게 관리해야 하는지&quot;였습니다.
                        </p>
                        <figure className="ut-results-screenshot">
                            <Image src="" alt="환자 SEQ 종합 평가표" />
                            <figcaption>
                                순차 과업 난이도(SEQ) 결과표입니다. 환자 과업 중에서는 메인 화면과
                                기록 이해(4.6점) 가 가장 어려웠고, 증상 기록(6.2점) 이 가장 수월하게
                                평가됐습니다.
                            </figcaption>
                        </figure>
                    </div>
                    <div className="ut-results-item">
                        ...
                        <p className="typography-copy">
                            중요 정보 확인 과업 2점(최저), AI 후보 &middot; 근거 검토 7점(최고).
                            필요한 것은 AI 기능 추가가 아니라 출처가 분명한 짧은 요약이었습니다.
                        </p>
                        <figure className="ut-result-screenshot">
                            <Image src="" alt="의사 SEQ 종합 평가표" />
                            <figcaption>
                                순차 과업 난이도(SEQ) 결과표입니다. 의사 과업 중에서는 중요 정보
                                실제 확인(2점) 이 가장 어려웠고, 인공지능 후보 &middot; 근거
                                검토(7점) 가 가장 수월하게 평가됐습니다
                            </figcaption>
                        </figure>
                    </div>
                    <div className="ut-results-item">
                        ...
                        <p className="typograph-copy">
                            환자에게는 이유와 관리 계획이, 의사에게는 흐름을 방해하지 않는 짧은
                            요약이 먼저 필요했습니다.
                        </p>
                    </div>
                    <div className="ut-results-item">
                        ...
                        <p className="typography-copy">
                            전문가 평가는 이 서비스를 기능 부족보다 정보 제시 방식과 역할 전달의
                            문제로 봤습니다. 즉 환자와 의사의 반응이 보여준 문제를, 전문가 평가가
                            정보 구조의 관점에서 다시 확인해준 셈이었습니다.
                        </p>
                    </div>
                    <div className="ut-results-item">
                        <h4 className="ut-results-headline">이번 사용성 테스트의 한계.</h4>
                        <p className="typography-copy">
                            이번 테스트는 방향성 확인에는 유효했지만, 일반화에는 한계가 있습니다.
                            의사 표본 1명, 더미 데이터 사용. 실제 임상 환경의 반복 사용 효과까지
                            입증한 것은 아닙니다.
                        </p>
                    </div>
                    <Link
                    ...
                    <div className="ut-overview">
                        ...
                        <dl className="ut-meta-info">
                            <div className="ut-meta-info-item">
                                <dt>목적</dt>
                            ...
                            <div className="ut-meta-info-item">
                                <dt>참여자</dt>
                                <dd>
                                    환자군 5명 (대면) &middot; 의사 1명 (비대면, Google Meet)
                                    &middot; 전문가 1명 (대학교수, HCI전공, 서면)
                                </dd>
                            </div>
                            <div className="ut-meta-info-item">
                                <dt>방법</dt>
                                <dd>
                                    <ul>
                                        <li>
                                            환자군 &middot; 의사군 -- 사전 인터뷰 &middot; 과업 진행
                                            + SEQ 평가 &middot; 사후 인터뷰 &middot; SUS 평가
                                        </li>
                                        <li>
                                            전문가 -- 휴리스틱 평가 (환자군 &middot; 의사군에 대한
                                            보조 근거로 활용)
                                        </li>
                                    </ul>
                                </dd>
                        ...
                        <div className="ut-interview">
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    <span>
                                        “이 처방에 28일, 14일이 처음에는 조금 이해가 안 갔어요.
                                        이번에 이것들을 허용을 해 줬다는 건지, 이걸 한 번에 두 개씩
                                        한 개씩 8일씩 처방해 준 건가 약간 그 부분이 조금
                                        어려웠습니다.”
                                    </span>
                                </figcaption>
                            </figure>
                            ...
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    <span>
                                        “저는 그 체크인 하는 과정이 아무래도 좀 요약이 많이 돼서
                                        지금 맥락이 뚝 끊겨서 체크인이라는 말도 조금 낯설고, 내가
                                        병원 접수가 되는 건지 병원에 가서 이걸 의사한테 전송을
                                        하겠다는 뜻인지 약간 헷갈리는 부분이 있어요.”
                                    </span>
                                </figcaption>
                            </figure>
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    <span>
                                        ...
                                        있잖아요. 근데 이 화면에서 이 결과를 받았다는 건 의사가
                                        검토를 한 결과잖아요?”
                                    </span>
                                </figcaption>
                            </figure>
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    <span>
                                        “기능성 특별 질환 의심, 자율신경계 평가 필요 이런 건 사실
                                        저는 잘 몰라요. 아니면은 언제 꼭 와라, 이거는 정말 지켜봐야
                                        된다 이런 식으로 아무것도 모르는 나도 좀 이해할 수 있을 법한
                                        그냥 한 줄 요약 정도가 좀 있으면 참 좋을 것 같아요.”
                                    </span>
                                </figcaption>
                            </figure>
                            <figure>
            ...
            <section className="section section-dd-deliver">
                <div className="section-content">
                    ...
                    <p className="section-headline-small">
                        환자에게는 나에게 맞는 설명과 데이터를, 의사에게는 바로 훑을 수 있는
                        요약으로 빠르게 환자를 파악할 수 있게.
                    </p>
                    <p className="typography-copy">
            ...
            <section className="section section-dd-deliver-key-changes">
                ...
                <div className="key-change-item">
                    <div className="key-change-content">
                        <h3 className="key-change-headline">
                            Key Change 01. 환자 앱 메인 화면 &middot; Eum Patient Application
                        </h3>
                        <p className="section-headline-small">
                        ...
                        <dl className="key-change-summary">
                            <div className="key-change-item">
                                <dt>문제</dt>
                                <dd>
                                    서비스가 무엇을 도와주는지 첫 화면에서 바로 이해되지 않았다.
                                </dd>
                            </div>
                            <div className="key-change-item">
                                <dt>원칙</dt>
                            ...
                            <div className="key-change-item">
                                <dt>기대 효과</dt>
                                <dd>
                                    환자는 “어디를 눌어야 하는가”보다 “지금 내 상태가 무엇인가”를
                                    먼저 이해할 수 있다.
                                </dd>
                            </div>
                        </dl>
            ...
            <section className="section section-dd-deliver-structure-update">
                <div className="section-content">
                    ...
                    <p className="typography-copy">
                        ...
                        하나의 흐름으로 읽히지 않으면 기능 모음처럼 보일 수 있었기 때문입니다.
                        그래서 정보 구조(IA)와 사용자 흐름(User Flow)을 기능 나열이 아니라, 상태
                        확인 → 진료 연결 → 결과 이해 순서가 먼저 읽히도록 핵심 루프 중심으로 다시
                        정리했습니다.
                    </p>
                    <dl className="ai-workflow">
                        <dt>AI 워크플로우</dt>
            ...
            <section className="section section-final-result">
                <div className="section-content">
                    ...
                    <p className="typography-copy">
                        ...
                        다음 행동으로 남게 하는 최소 구조로 정리되었습니다. 제품 관점에서는 핵심
                        루프를 더 선명하게 남겼고, 구현 관점에서는 실제 AI가 연결된 프로토타입과
                        화면 &middot; 기능 &middot; 로직 정의까지 함께 전달했습니다.
                    </p>
                </div>
            </section>
        </main>
